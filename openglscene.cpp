    ...
    , m_angularMomentum(0, 0, 0)
{
    ...
    loadModel(QLatin1String("Solidworks Models/40-4040 - 4.obj"));
    m_time.start();
}
...
void OpenGLScene::drawBackground(QPainter *painter, const QRectF &)
{
    ...
    if( m_model2 )
    {
        //cout << "render object 2" << endl;
        m_model2->render(m_wireframeEnabled, m_normalsEnabled);
    }
...
void OpenGLScene::setObject2(OpenGL_Object* object)
{
    m_model2 = object;
}
